...
# # Load language prediction models from .txt files
# @st.cache_data
...
#         if file.endswith('.txt'):  # Only load .txt files
#             file_path = os.path.join(base_path, file)
#             try:
#                 with open(file_path, 'r') as f:  # Open file as text
#                     language_data = f.read()  # Read the content of the file
#                     language_models[file] = language_data  # Store the text content
...
# # Extract language predictions from model dictionary
# def extract_language_predictions(model_dict):
#     try:
#         if isinstance(model_dict, dict):
#             return model_dict
#     except Exception as e:
#         logging.error(f"Error extracting language prediction: {e}")
#     return None

# # Fallback language prediction using langdetect
...
# # Render language prediction results as table with centered content
# def render_language_prediction_table(prediction: dict):
#     st.markdown("### 📊 Language Prediction Results")

#     # Prepare the data
#     data = {
#         "Metric": ["Predicted Language"],
#         "Prediction": [prediction['predicted_language']]
#     }
...
#             render_language_prediction_table(result)
#         else:
#             st.warning("Please enter some text.")

# # Preloaded file UI
# def display_preloaded_language_prediction():
#     st.subheader("📁 Preloaded Language Prediction Files")
...
#         predictions = extract_language_predictions(language_data[selected_file])
#         if predictions:
...
#         if predictions:
#             df = pd.DataFrame(predictions, columns=["SN", "Text", "Predicted Language"])
#             st.markdown(f"### 🔍 Language Prediction from: `{selected_file}`")
