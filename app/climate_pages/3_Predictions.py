...
uploaded_file = st.file_uploader("Upload the Cleaned Climate Data CSV", type=["csv"])

if uploaded_file:
    df, X, y, y_log, y_class = load_data_from_uploaded_file(uploaded_file)
    if df is None:
        st.stop()
